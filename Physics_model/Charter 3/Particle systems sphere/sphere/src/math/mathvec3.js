import { D2R } from "./mathmat4.js";
  ...
  static rotate_vector(a, b, Angle){
    let u = _vec3.normalize(b);
    let teta =  D2R(Angle);
    return _vec3.add(_vec3.mulnum(a, Math.cos(teta)), _vec3.add(_vec3.mulnum(_vec3.cross(u, a), Math.sin(teta)), _vec3.mulnum(u, _vec3.dot(u, a) * (1 - Math.cos(teta)))))
  }
